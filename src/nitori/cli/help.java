...
public class help {
  private static String title() {return "Nitori version 1.6";}

  public static void printHelp() {
    if (platform.isFreeBSD()) printHelp_freebsd();
    else printHelp_linux();
  }
  
  public static void printHelp_linux() {
    System.out.println(
      title()
      ...
      + "\n  * -cf (--cpu-freq) <clock speed>        Sets both the minimum and maximum clock speed in megahertz (MHz)"
  ...
  public static void printHelp_freebsd() {
    System.out.println(
      title()
      + "\nUsage: nitori <arguments>"
      ...
      +"The functionality below is unsupported on FreeBSD"
      + "\n  * -cmin (--cpu-min) <clock speed>          Sets the minimum CPU clock speed in megahertz (MHz)"
      + "\n  * -cmax (--cpu-max) <clock speed>          Sets the maximum CPU clock speed in megahertz (MHz)"
      + "\n  * -cg (--cpu-governor) <governor>          Sets the CPU kernel governor"
      + "\n  * -ce (--cpu-energy-preference) <mode>     Sets the CPU energy balance preference if available"
